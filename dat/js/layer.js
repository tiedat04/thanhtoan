...
!function (e, t) {
  ...
  r = {
    ...
    ie: function () {
      ...
      return !!(e.ActiveXObject || 'ActiveXObject' in e) && ((t.match(/msie\s(\d+)/) || [
      ]) [1] || '11')
    }(),
  ...
  s.pt.vessel = function (e, t) {
    ...
    u = r.title ? '<div class="layui-layer-title" style="' + (f ? r.title[1] : '') + '">' + (f ? r.title[0] : r.title) + '</div>' : '',tishiIco = r.skin == 'errorts' ? '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-cuowu"></use></svg>' : '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-chenggong"></use></svg>';
    return r.zIndex = s,
    t([r.shade ? '<div class="layui-layer-shade" id="layui-layer-shade' + a + '" times="' + a + '" style="' + ('z-index:' + (s - 1) + '; ') + '"></div>' : '',
    '<div class="' + l[0] + (' layui-layer-' + o.type[r.type]) + (0 != r.type && 2 != r.type || r.shade ? '' : ' layui-layer-border') + ' ' + (r.skin || '') + '" id="' + l[0] + a + '" type="' + o.type[r.type] + '" times="' + a + '" showtime="' + r.time + '" conType="' + (e ? 'object' : 'string') + '" style="z-index: ' + s + '; width:' + r.area[0] + ';height:' + r.area[1] + (r.fixed ? '' : ';position:absolute;') + '">' + (e && 2 != r.type ? '' : u) + '<div id="' + (r.id || '') + '" class="layui-layer-content' + (0 == r.type && r.icon !== - 1 ? ' layui-layer-padding' : '') + (3 == r.type ? ' layui-layer-loading' + r.icon : '') + '">' + (0 == r.type && r.icon !== - 1 ? tishiIco : '') + (1 == r.type && e ? '' : r.content || '') + '</div><span class="layui-layer-setwin">' + function () {
      ...
      switch ('string' == typeof t.area && (t.area = 'auto' === t.area ? [
        ...
        case 2:
          var s = t.content = f ? t.content : [
            t.content || 'http://layer.layui.com',
            'auto'
          ];
